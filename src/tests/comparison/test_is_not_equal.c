...
Suite *test_is_not_equal() {
  Suite *suite = suite_create("is_not_equal");
  TCase *tcase = tcase_create("is_not_equal_tcase");

  tcase_add_test(tcase, is_not_equal_test_1);
  tcase_add_test(tcase, is_not_equal_test_2);
  tcase_add_test(tcase, is_not_equal_test_3);
